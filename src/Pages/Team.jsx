    ...
    <div className="m-2 minmd:m-0 ">
      <div className=" lg:mx-2 minlg:mx-3">
        <div className="col-span-3 text-left h-[80vh] my-10">
          <h2 className="text-md minmd:text-md text-left text-white">DREAM</h2>
          <h1 className="text-6xl minmd:text-3xl font-semibold font-IBMplex text-left tracking-widest bg-gradient-to-r  from-[#E61AA1]  to-[#0CF996] to-10% bg-clip-text text-transparent mb-3 mr-auto">
            TEAM
          </h1>
          <p className="text-stone-500 w-96 font-IBMplex lg:p-4 minmd:w-fit text-xs mr-4 overflow-x-auto">
      ...
      <div className="field m-auto -translate-y-[6rem] minlg:-translate-y-24">
        {/* <div class="mouse"></div> */}
        <a href="#Team">
